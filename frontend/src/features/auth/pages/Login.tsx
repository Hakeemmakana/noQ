...
import { googleLogin, loginApi } from '../service/authService';
import { useDispatch } from 'react-redux';
import { userLogin } from '../authSlice/userAuthSlice';
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-blue-50 to-slate-100 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-200/60 border border-white/80 p-8">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-2">
              ...
              <Link to={"/auth/forgot-password"} className="text-sm font-semibold text-blue-500 hover:text-blue-600 transition-colors">
                Forgot Password?
              </Link>
            </div>
            <div className="relative">
          ...
          {/* Google Button */}
          <button onClick={handleGoogleLogin} className="w-full flex items-center justify-center gap-3 py-3.5 rounded-2xl border-2 border-gray-100 bg-white hover:bg-gray-50 hover:border-gray-200 transition-all text-sm font-bold text-gray-600 shadow-sm hover:shadow-md group">
            {/* Google SVG */}
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          ...
          <Link to='/auth/singUp' className="text-blue-500 font-bold hover:text-blue-600 transition-colors">
            Create one
          </Link>
        </p>
      </div>
