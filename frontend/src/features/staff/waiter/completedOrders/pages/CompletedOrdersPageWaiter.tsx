...
import type { ICompletedOrder, CompletedOrderFilters } from "../types/orderTypes";
      ...
      if (filters.dateFilter === "custom") {
        if(typeof payload=='object'&&payload!==null){
          const customPayload = payload as {
            customFrom?: typeof customFrom;
            customTo?: typeof customTo;
        };
        customPayload.customFrom = customFrom || undefined;
        customPayload.customTo = customTo || undefined;
        }
      }
