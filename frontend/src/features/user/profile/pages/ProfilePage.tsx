...
import type { FieldErrors, ProfileFormData, UserProfile } from "../types/profileTypes";
...
import { setUserImage, setUserName } from "../../../auth/authSlice/userAuthSlice";
...
export default function ProfilePage() {
  ...
  const handleProfileSubmit = async () => {
    ...
    try {
      ...
      if (profile.name !== profileForm.name) {
        dispatch(setUserName(profileForm.name.trim()));
      }
