...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="hidden xl:fixed xl:left-0 xl:top-0 xl:z-40 xl:flex xl:h-screen xl:w-[270px] xl:flex-col xl:justify-between xl:overflow-y-auto xl:border-r xl:border-[#E8E9F0] xl:bg-white">
      ...
      <div className="border-t border-[#E8E9F0] p-4">
        <div className="flex items-center justify-between rounded-2xl bg-[#F7F7FB] px-4 py-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-bold text-[#202437]">{admin?.name ??'admin'}</p>
          ...
          <button
            ...
            className="text-[#7B8098] transition hover:text-[#1D27F3]"
          >
            <LogOut size={18} />
          </button>
        </div>
