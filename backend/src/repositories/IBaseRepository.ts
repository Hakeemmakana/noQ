...
export class BaseRepository<T> {
    ...
    async updateById(
        ...
        return await this.model.findByIdAndUpdate(id,update,{update:true})
    }
    async getByFilter(filter:FilterQuery<T>):Promise<HydratedDocument<T>|null>{
    ...
    async deleteByFilter(filter:FilterQuery<T>):Promise<HydratedDocument<T>|null>{
