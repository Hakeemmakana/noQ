import { IStaffDto } from "../../../dtos/admin/staff/staff-create.dto";
import { IStaff } from "../../../models/staff";
import { PaginatedResult } from "../../../types/pagination";

export interface IStaffRepository {
    createStaff(data: IStaffDto,hotelId:string): Promise<IStaff>;
    ...
    updateStaff(id: string, data: IStaffDto): Promise<IStaff | null>;
