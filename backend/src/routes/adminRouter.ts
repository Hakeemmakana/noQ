...
router.route('/menu/varient/:id')
  .get(menuItemController.getMenuItem)
  .post(upload.single('image'),menuItemController.menuVariantAdd)
router.route('/menu/:productId/variants/:variantId')
  .put(upload.single('image'),menuItemController.menuVariantEdit)
  .delete(menuItemController.menuVariantDelete)
//order
...
//dashboard
const reportController=container.get<IReportController>(TYPES.ReportController)
router.get('/dashboard',reportController.getDashboard)
router.get('/pdfReport',reportController.getPdfReport)
router.get('/csvReport',reportController.getCsvReport)
