...
import {  ICategoryResponseDto, ICategoryResponseForUserDto } from "../../../dtos/admin/category/category-response.dto";
import { ICategory } from "../../../models/category";
import { PaginatedResult } from "../../../types/pagination";

export default interface ICategoryService {
    getAllCategory(data:IGetCategoryDto, hotelId: string): Promise<PaginatedResult<ICategoryResponseDto>>;
    getAllCategoryForUser( hotelId: string): Promise<ICategoryResponseForUserDto[]>;
