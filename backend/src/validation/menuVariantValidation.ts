import type { IMenuVariantFormValues, StockMode } from "../dtos/menuItems/mernuVariant-req.dto";
...
export function validateMenuVariantFormInService(
  values: IMenuVariantFormValues,
  stockMode: StockMode
): variantErrorReturn {
  const errors:  Record<string, string> = {};
